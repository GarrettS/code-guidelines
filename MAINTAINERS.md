...
- **Codex**: generated flat spec files in `adapters/codex/`, built from `adapters/shared-base/skills/` plus Codex bindings and read directly from `~/.web-xp/adapters/codex/`. Generated setup skills are installed to `~/.codex/skills/`. See `adapters/codex/README.md`.
...
│       └── skills/             # Codex setup skills (installed to ~/.codex/skills/)
│           ├── web-xp-init/
│           └── web-xp-remove/
├── .claude/
