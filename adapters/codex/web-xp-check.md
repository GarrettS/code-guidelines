...
Run `bash bin/pre-commit-check.sh` (or the project-local equivalent). If it reports violations, list them and stop — mechanical issues must be fixed before structural review.
